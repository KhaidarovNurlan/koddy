...
export const cppJourney: Journey = {
  id: 'cpp-journey',
  language: 'cpp',
  title: 'C++ Journey',
  chapters: [
    {
      ...
      lessons: [
          ...
          quiz: {
            ...
            questions: [
              ...
              },
              {
                ...
                codeSnippet: 'cout << "Hello World!" << endl;',
                options: [
                  { text: 'cout << "Hello World!" << endl;', isCorrect: false, explanation: 'The print function evaluates the contents, it does not output the function call itself.' },
        ...
        },
        {
          ...
          codingChallenge: {
            title: 'Mastery Challenge',
            description: 'Show your mastery of C++ print syntax and calculations.',
            solution: 'cout << 5 * 5 << endl;\ncout << "Finished" << endl;',
            hints: [
        ...
        },
        {
          id: 'cpp-ch1-l4',
          title: 'Variables',
          description: 'Learn how to store data using variables in C++.',
          type: 'lesson-all',
          codingChallenge: {
      ...
      lessons: [
        ...
        },
        {
          ...
          codingChallenge: {
            ...
            solution: "int sum_even(int n) {\\n    int total = 0;\\n    for (int i = 1; i <= n; i++) {\\n        if (i % 2 == 0) {\\n            total += i;\\n        }\\n    }\\n    return total;\\n}\\n\\ncout << sum_even(5) << endl;",
            hints: [
        ...
        },
        {
          ...
          codingChallenge: {
            ...
            solution: "void greet(string name) {\\n    cout << \"Hello, \" << name << endl;\\n}\\n\\ngreet(\"Bob\");",
            hints: [
      ...
      lessons: [
        ...
        },
        {
          ...
          codingChallenge: {
            ...
            solution: "int add(int x, int y) { return x + y; }\\nint subtract(int x, int y) { return x - y; }\\nint multiply(int x, int y) { return x * y; }\\nstring divide(int x, int y) {\\n    if (y == 0) return \"Error: Division by zero\";\\n    return to_string((double)x / y);\\n}\\n\\nstring calculate(int choice, int x, int y) {\\n    if (choice == 1) {\\n        return to_string(add(x, y));\\n    } else if (choice == 2) {\\n        return to_string(subtract(x, y));\\n    } else if (choice == 3) {\\n        return to_string(multiply(x, y));\\n    } else if (choice == 4) {\\n        return divide(x, y);\\n    } else {\\n        return \"Invalid Choice\";\\n    }\\n}\\n\\ncout << calculate(1, 10, 5) << endl;\\ncout << calculate(3, 10, 5) << endl;",
            hints: [
