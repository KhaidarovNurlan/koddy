...
export const javascriptJourney: Journey = {
  ...
  chapters: [
    {
      ...
      lessons: [
          ...
          quiz: {
            ...
            questions: [
              ...
              },
              {
                ...
                options: [
                  { text: 'console.log("Hello World!")', isCorrect: false, explanation: 'The print function evaluates the contents, it does not output the function call itself.' },
        ...
        {
          id: 'javascript-ch1-l3',
          title: 'Mastery Challenge',
          description: 'Prove your knowledge with Mastery!',
          type: 'lesson-mastery',
          codingChallenge: {
            title: 'Mastery Challenge',
            description: 'Show your mastery of Javascript print syntax and calculations.',
      ...
      lessons: [
        ...
        },
        {
          ...
          codingChallenge: {
            ...
            solution: "function sum_even(n) {\\n    let total = 0;\\n    for (let i = 1; i <= n; i++) {\\n        if (i % 2 === 0) {\\n            total += i;\\n        }\\n    }\\n    return total;\\n}\\n\\nconsole.log(sum_even(5))",
            hints: [
    ...
    },
    {
      id: 'ch3',
      title: 'Calculator',
      description: 'Build a calculator in Javascript',
      lessons: [
        {
          id: 'javascript-ch3-l1',
        ...
        },
        {
          ...
          codingChallenge: {
            ...
            solution: "function add(x, y) { return x + y; }\\nfunction subtract(x, y) { return x - y; }\\nfunction multiply(x, y) { return x * y; }\\nfunction divide(x, y) {\\n    if (y === 0) return \"Error: Division by zero\";\\n    return x / y;\\n}\\n\\nfunction calculate(choice, x, y) {\\n    if (choice === 1) {\\n        return add(x, y);\\n    } else if (choice === 2) {\\n        return subtract(x, y);\\n    } else if (choice === 3) {\\n        return multiply(x, y);\\n    } else if (choice === 4) {\\n        return divide(x, y);\\n    } else {\\n        return \"Invalid Choice\";\\n    }\\n}\\n\\nconsole.log(calculate(1, 10, 5))\\nconsole.log(calculate(3, 10, 5))",
            hints: [
