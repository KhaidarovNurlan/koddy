...
export const javaJourney: Journey = {
  id: 'java-journey',
  language: 'java',
  title: 'Java Journey',
  chapters: [
    {
      ...
      lessons: [
          ...
          quiz: {
            ...
            questions: [
              ...
              },
              {
                ...
                options: [
                  { text: 'System.out.println("Hello World!");', isCorrect: false, explanation: 'The print function evaluates the contents, it does not output the function call itself.' },
        ...
        },
        {
          ...
          codingChallenge: {
            title: 'Mastery Challenge',
            description: 'Show your mastery of Java print syntax and calculations.',
            solution: 'System.out.println(5 * 5);\nSystem.out.println("Finished");',
            hints: [
        ...
        },
        {
          id: 'java-ch1-l4',
          title: 'Variables',
          description: 'Learn how to store data using variables in Java.',
          type: 'lesson-all',
          codingChallenge: {
      ...
      lessons: [
        ...
        },
        {
          ...
          codingChallenge: {
            ...
            solution: "public static int sum_even(int n) {\\n    int total = 0;\\n    for (int i = 1; i <= n; i++) {\\n        if (i % 2 == 0) {\\n            total += i;\\n        }\\n    }\\n    return total;\\n}\\n\\nSystem.out.println(sum_even(5));",
            hints: [
    ...
    },
    {
      id: 'ch3',
      title: 'Calculator',
      description: 'Build a calculator in Java',
      lessons: [
        {
          id: 'java-ch3-l1',
        ...
        },
        {
          ...
          codingChallenge: {
            ...
            solution: "public static int add(int x, int y) {\\n    return x + y;\\n}\\n\\npublic static int subtract(int x, int y) {\\n    return x - y;\\n}\\n\\nSystem.out.println(add(10, 5));\\nSystem.out.println(subtract(10, 5));",
            hints: [
        ...
        },
        {
          ...
          codingChallenge: {
            ...
            solution: "public static int add(int x, int y) { return x + y; }\\npublic static int subtract(int x, int y) { return x - y; }\\npublic static int multiply(int x, int y) { return x * y; }\\npublic static Object divide(int x, int y) {\\n    if (y == 0) return \"Error: Division by zero\";\\n    return (double) x / y;\\n}\\n\\npublic static Object calculate(int choice, int x, int y) {\\n    if (choice == 1) {\\n        return add(x, y);\\n    } else if (choice == 2) {\\n        return subtract(x, y);\\n    } else if (choice == 3) {\\n        return multiply(x, y);\\n    } else if (choice == 4) {\\n        return divide(x, y);\\n    } else {\\n        return \"Invalid Choice\";\\n    }\\n}\\n\\nSystem.out.println(calculate(1, 10, 5));\\nSystem.out.println(calculate(3, 10, 5));",
            hints: [
