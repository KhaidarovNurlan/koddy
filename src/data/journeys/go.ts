...
export const goJourney: Journey = {
  id: 'go-journey',
  language: 'go',
  title: 'Go Journey',
  chapters: [
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          codingChallenge: {
            title: 'Mastery Challenge',
            description: 'Show your mastery of Go print syntax and calculations.',
            solution: "print(5 * 5)\\nprint(\"Finished\")",
            hints: [
        ...
        },
        {
          id: 'go-ch1-l4',
          title: 'Variables',
          description: 'Learn how to store data using variables in Go.',
          type: 'lesson-all',
          codingChallenge: {
    ...
    },
    {
      id: 'ch3',
      title: 'Calculator',
      description: 'Build a calculator in Go',
      lessons: [
        {
          id: 'go-ch3-l1',
