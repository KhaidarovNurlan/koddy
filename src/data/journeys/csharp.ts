...
export const csharpJourney: Journey = {
  id: 'csharp-journey',
  language: 'csharp',
  ...
  chapters: [
    {
      id: 'ch1',
      title: 'Introduction',
      description: 'Get started with Csharp',
      lessons: [
        {
          id: 'csharp-ch1-l1',
        ...
        },
        {
          id: 'csharp-ch1-l2',
          title: 'The Language',
          description: 'Learn the basics of Csharp programming.',
          type: 'lesson-theory',
          quiz: {
            title: 'Quiz Time',
        ...
        },
        {
          ...
          codingChallenge: {
            title: 'Mastery Challenge',
            description: 'Show your mastery of Csharp print syntax and calculations.',
            solution: "print(5 * 5)\\nprint(\"Finished\")",
            hints: [
        ...
        },
        {
          id: 'csharp-ch1-l4',
          title: 'Variables',
          description: 'Learn how to store data using variables in Csharp.',
          type: 'lesson-all',
          codingChallenge: {
    ...
    },
    {
      id: 'ch3',
      title: 'Calculator',
      description: 'Build a calculator in Csharp',
      lessons: [
        {
          id: 'csharp-ch3-l1',
