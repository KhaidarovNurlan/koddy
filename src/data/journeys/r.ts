  ...
  chapters: [
    {
      ...
      lessons: [
        ...
        },
        {
          id: 'r-ch1-l2',
          title: 'The Language',
          description: 'Learn the basics of R programming.',
          type: 'lesson-theory',
          quiz: {
            title: 'Quiz Time',
        ...
        },
        {
          ...
          codingChallenge: {
            title: 'Mastery Challenge',
            description: 'Show your mastery of R print syntax and calculations.',
            solution: "print(5 * 5)\\nprint(\"Finished\")",
            hints: [
        ...
        },
        {
          id: 'r-ch1-l4',
          title: 'Variables',
          description: 'Learn how to store data using variables in R.',
          type: 'lesson-all',
          codingChallenge: {
    ...
    },
    {
      id: 'ch3',
      title: 'Calculator',
      description: 'Build a calculator in R',
      lessons: [
        {
          id: 'r-ch3-l1',
