...
export const rubyJourney: Journey = {
  id: 'ruby-journey',
  language: 'ruby',
  title: 'Ruby Journey',
  chapters: [
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          codingChallenge: {
            title: 'Mastery Challenge',
            description: 'Show your mastery of Ruby print syntax and calculations.',
            solution: "print(5 * 5)\\nprint(\"Finished\")",
            hints: [
        ...
        },
        {
          id: 'ruby-ch1-l4',
          title: 'Variables',
          description: 'Learn how to store data using variables in Ruby.',
          type: 'lesson-all',
          codingChallenge: {
    ...
    },
    {
      id: 'ch3',
      title: 'Calculator',
      description: 'Build a calculator in Ruby',
      lessons: [
        {
          id: 'ruby-ch3-l1',
