...
export const rustJourney: Journey = {
  id: 'rust-journey',
  language: 'rust',
  title: 'Rust Journey',
  chapters: [
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          codingChallenge: {
            title: 'Mastery Challenge',
            description: 'Show your mastery of Rust print syntax and calculations.',
            solution: "print(5 * 5)\\nprint(\"Finished\")",
            hints: [
        ...
        },
        {
          id: 'rust-ch1-l4',
          title: 'Variables',
          description: 'Learn how to store data using variables in Rust.',
          type: 'lesson-all',
          codingChallenge: {
    ...
    },
    {
      id: 'ch3',
      title: 'Calculator',
      description: 'Build a calculator in Rust',
      lessons: [
        {
          id: 'rust-ch3-l1',
