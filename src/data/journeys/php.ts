...
export const phpJourney: Journey = {
  id: 'php-journey',
  language: 'php',
  title: 'Php Journey',
  chapters: [
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          codingChallenge: {
            title: 'Mastery Challenge',
            description: 'Show your mastery of Php print syntax and calculations.',
            solution: "print(5 * 5)\\nprint(\"Finished\")",
            hints: [
        ...
        },
        {
          id: 'php-ch1-l4',
          title: 'Variables',
          description: 'Learn how to store data using variables in Php.',
          type: 'lesson-all',
          codingChallenge: {
    ...
    },
    {
      id: 'ch3',
      title: 'Calculator',
      description: 'Build a calculator in Php',
      lessons: [
        {
          id: 'php-ch3-l1',
