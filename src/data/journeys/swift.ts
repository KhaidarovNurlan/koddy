...
export const swiftJourney: Journey = {
  id: 'swift-journey',
  language: 'swift',
  title: 'Swift Journey',
  chapters: [
    {
      id: 'ch1',
      title: 'Introduction',
      description: 'Get started with Swift',
      lessons: [
        {
          id: 'swift-ch1-l1',
        ...
        },
        {
          ...
          codingChallenge: {
            title: 'Mastery Challenge',
            description: 'Show your mastery of Swift print syntax and calculations.',
            solution: "print(5 * 5)\\nprint(\"Finished\")",
            hints: [
        ...
        },
        {
          id: 'swift-ch1-l4',
          title: 'Variables',
          description: 'Learn how to store data using variables in Swift.',
          type: 'lesson-all',
          codingChallenge: {
    ...
    },
    {
      id: 'ch3',
      title: 'Calculator',
      description: 'Build a calculator in Swift',
      lessons: [
        {
          id: 'swift-ch3-l1',
