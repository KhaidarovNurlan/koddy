...
const footerColumns = [
    ...
    },
    {
        title: 'Languages',
        links: [
            { name: 'Python', href: '/journeys/python' },
            { name: 'JavaScript', href: '/journeys/javascript' },
            { name: 'C++', href: '/journeys/cpp' },
            { name: 'Java', href: '/journeys/java' },
            { name: 'C#', href: '/journeys/csharp' },
            { name: 'PHP', href: '/journeys/php' },
            { name: 'Dart', href: '/journeys/dart' },
            { name: 'Golang', href: '/journeys/go' },
            { name: 'Rust', href: '/journeys/rust' },
            { name: 'Lua', href: '/journeys/lua' },
        ],
    },
    {
        title: 'Knowledge',
