...
const navLinkStyles = ({ isActive }: { isActive: boolean }) =>
    isActive
        ? "text-blue-light border-b-2 border-blue-light pb-1"
...
export function CompanyHeader() {
    ...
    return (
        <>
            <nav className="sticky top-0 z-50 bg-grey-dark border-b border-grey-lighter/50">
            ...
            <div className={`fixed inset-y-0 left-0 z-[70] w-[280px] bg-grey border-r border-grey-lighter transform transition-transform duration-300 md:hidden flex flex-col ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className="p-6 border-b border-grey-lighter/50 h-20 flex items-center justify-between">
